                    ...
                    <div class="relative overflow-x-auto p-6">
                        <table
                            ...
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    <th style="width: 50%" scope="col" class="px-6 py-3">Правильный ответ</th>
...
import Question from "@/Pages/Teacher/Tests/Components/Question.vue";
import StudentAnswers from "@/Pages/Teacher/Statistics/components/StudentAnswers.vue";

export default {
    name: "List",
    components: { Question, Layout, Link, StudentAnswers },
    props: {
        test: Object,
        questions: Object,
        student: Object,
